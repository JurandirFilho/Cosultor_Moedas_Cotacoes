...
def selecionar_arquivo():
    ...
    if caminho_arquivo:
        label_arquivoselecionado['text'] = f'Arquvo Selecinado: {caminho_arquivo}'
...
combobox_selecionarmoedas.grid(row=1, column=2, padx=10, pady=10, sticky='nsew')

label_selecionardia = tk.Label(text='Seleciona o dia que deseja pegar a cotação', anchor='e')
...
label_cotacaovaiasmoedas = tk.Label(text='Cotação de Multiplas moedas', borderwidth=2, relief='solid')
label_cotacaovaiasmoedas.grid(row=4, column=0, padx=10, pady=10, sticky='nsew', columnspan=3)

label_selecionararquivo = tk.Label(text='Selecionar um arquivo em Excel com as Moedas na Coluna A')
label_selecionararquivo.grid(row=5, column=0, columnspan=2, padx=10, pady=10, sticky='nsew')

var_caminhoarquivo = tk.StringVar()

botao_selecionaraquivo = tk.Button(text='Clique para Selecionar', command=selecionar_arquivo)
botao_selecionaraquivo.grid(row=5, column=2, padx=10, pady=10, sticky='nsew')

label_arquivoselecionado = tk.Label(text='Nenhum Arquvio Selecionado', anchor='e')
label_arquivoselecionado.grid(row=6, column=0, columnspan=3, padx=10, pady=10, sticky='nsew')

label_dataincial = tk.Label(text='Data Incial', anchor='e')
label_dataincial.grid(row=7, column=0, padx=10, pady=10, sticky='nsew')

calendario_datainical = DateEntry(year=2023, locale='pt_br')
calendario_datainical.grid(row=7, column=1, padx=10, pady=10, sticky='nsew')
